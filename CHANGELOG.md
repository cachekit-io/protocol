...
- Provenance: `test-vectors/cache-keys.json` is untouched by this change
  (generated by `cachekit-py` v0.12.0); cachekit-py CI byte-verifies its
  vendored copy against `CacheKeyGenerator`
