...
| `minimal`: L1 | **on** (SWR / invalidation off) | **off** on 0.7.0 (`no_l1()`, `intents.rs:77`); **on** (SWR / invalidation off) from the first release containing the fix in [cachekit-rs#85](https://github.com/cachekit-io/cachekit-rs/pull/85) — unreleased as of 2026-09-23 | **on** (SWR / invalidation off) |
