...
The protocol surface an SDK implements for its **own** caching (auto mode):
...
| Wire format (ByteStorage) | ✅ Compliant¹ | ⚠️ SDK stores plain MessagePack — no envelope¹ | ✅ Compliant | ⚠️ Untested |
| Storage container (auto mode)¹ | CK v3 frame (Python-internal) | Plain MessagePack (`rmp` named) | Bare ByteStorage envelope | — |
